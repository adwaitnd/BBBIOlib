...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Prep_fft.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/oliver/Dropbox/CMU\ courses/ML/Matlab\ Coder
ARCH                      = glnxa64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Prep_fft.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/Prep_fft -I/home/oliver/Dropbox/CMU -I$(START_DIR)/courses/ML/Occ_Scripts -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Prep_fft -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/Prep_fft/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/Prep_fft/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
