...
static real32_T (*e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[57600];
  ...
  const emlrtMsgIdentifier *msgId))[57600]
{
  ...
  int32_T iv1[1];
  iv1[0] = 57600;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "single", false, 1U, iv1);
  ret = (real32_T (*)[57600])mxGetData(src);
